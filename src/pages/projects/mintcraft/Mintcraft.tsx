				...
				<div className="content">
					...
					<List>
						<ListItem>
							...
							<ListItemText>
								Use and modify Mintcraft and/or its add-ons to your liking and
								for personal use.
							</ListItemText>
						</ListItem>
						<ListItem>
					...
					<List>
						<ListItem>
							...
							<ListItemText>
								Share versions, parts and/or modifications of Mintcraft and/or
								its add-ons publicly.
							</ListItemText>
						</ListItem>
						<ListItem>
							<ListItemIcon>
					...
					>
						<Typography variant="h3">Vanilla Tweaks</Typography>
					</a>
					...
					<Typography variant="body1">
						...
						<br />
						The add-ons don't necessarily need to be in a certain order.
						However, if you have other packs installed that change things like
						the font and sounds, you might wanna put my add-ons above those as
						well.
					</Typography>
					<br />
