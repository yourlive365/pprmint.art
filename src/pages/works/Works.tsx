    ...
    <Grid item xs={12} sm={6}>
      ...
      <div id="right">
        <a href={props.link} target="_blank" rel="noopener noreferrer">
          <Button variant="text" color="default" style={{ marginTop: "8px" }}>
            {props.buttonText}
          </Button>
        </a>
      </div>
...
function Works() {
  return (
    <>
      ...
      <img src="./assets/blobs/works_header_blob.svg" style={{ position: "absolute", animation: "fadeTop 1s cubic-bezier(0, 0.7, 0.5, 1) .2s forwards", opacity: "0", }} />
      <Container id="wrapper">
      <Typography variant="h1" align="center">Works.</Typography>
      <div id="content">
        <br />
        <Grid container spacing={4}>
          <WorkCardVideo
            title="New current and old previous logos."
          ...
          />
          <WorkCardVideo
            title="Reverting a controversial change."
        ...
        <Typography variant="body1">
          ...
          Google Drive, because some of these look awful and I didn't want them
          to defile my website. If you're interested anyways: Feel free to check
          them out here:
        </Typography>
        <br />
        <a
